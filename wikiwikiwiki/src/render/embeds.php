...
function render_embed_codepen(string $value, string $original): string
{
    ...
    $iframe = '<iframe style="width: 100%; height: ' . html($height) . ';" src="' . html($embedUrl) . '" loading="lazy"></iframe>';
...
function render_embed_map(string $value, string $original): string
{
    ...
    $iframe = '<iframe style="height: ' . html($height) . ';" src="' . html($embedUrl) . '" frameborder="0" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>';
...
function render_embed_arena(string $value, string $original): string
{
    ...
    $iframe = '<iframe style="height: ' . html($height) . ';" src="' . html($embedUrl) . '" loading="lazy"></iframe>';
    return render_embed_figure($iframe, $width);
}
